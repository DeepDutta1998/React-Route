...
export const Navbar = () => {
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar-light bg-warning" id="mainNav">
            <div className="container px- px-lg-5">
                <a className="navbar-brand" href="index.html">Bootstrap</a>
